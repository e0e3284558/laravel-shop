<div class="box box-info">
    ...
    <div class="box-body">
        <table class="table table-bordered">
            ...
            <tr>
                <td>收货地址</td>
                <td colspan="3">{{$order->address['address']}} {{$order->address['zip']}} {{$order->address['contact_name']}} </td>
            </tr>
            <tr>
                    ...
                    <td colspan="4">
                        <form action="{{ route('admin.orders.ship',[$order->id]) }}" class="form-inline" method="post">
                            ...
                            <div class="form-group {{$errors->has('express_company')?'has-error':''}}">
                                ...
                                <input type="text" class="form-control" id="express_company" value="" name="express_company"
                                       placeholder="输入物流公司">
